  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Total Feedback */}
        <div className="p-6 rounded-xl bg-card-custom border border-card-border flex items-center justify-between shadow-sm hover:shadow-md transition-all duration-200">
          <div className="space-y-1">
            <span className="text-[10px] text-text-muted font-bold uppercase tracking-wider">Total Feedback</span>
            <p className="text-3xl font-extrabold tracking-tight text-text-primary">{stats.totalCount}</p>
            <span className="text-xs text-status-pos font-medium">Active filters dataset</span>
          </div>
          <div className="w-9 h-9 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0 shadow-inner">
        ...
        <div className="p-6 rounded-xl bg-card-custom border border-card-border flex items-center justify-between shadow-sm hover:shadow-md transition-all duration-200">
          <div className="space-y-1">
            <span className="text-[10px] text-text-muted font-bold uppercase tracking-wider">Negative Ratio</span>
            <p className={`text-3xl font-extrabold tracking-tight ${stats.negativePercent > 40 ? "text-status-neg" : "text-text-primary"}`}>
              {stats.negativePercent}%
            </p>
            <span className="text-xs text-text-secondary font-medium">Requires triage attention</span>
          </div>
          <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 shadow-inner ${stats.negativePercent > 40 ? "bg-status-neg/10 text-status-neg" : "bg-status-neu/10 text-status-neu"}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
        ...
        <div className="p-6 rounded-xl bg-card-custom border border-card-border flex items-center justify-between shadow-sm hover:shadow-md transition-all duration-200">
          <div className="space-y-1">
            <span className="text-[10px] text-text-muted font-bold uppercase tracking-wider">New This Week</span>
            <p className="text-3xl font-extrabold tracking-tight text-text-primary">+{stats.newThisWeek}</p>
            <span className="text-xs text-text-secondary font-medium">Last 7 calendar days</span>
          </div>
          <div className="w-9 h-9 rounded-lg bg-ai-accent/10 text-ai-accent flex items-center justify-center shrink-0 shadow-inner">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
